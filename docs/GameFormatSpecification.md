...
| `finishLocation` | object | Ending location configuration (Optional)                     |
| `attributes` | object | Game characteristics and difficulty ratings (Optional)       |
...
```
<img src="function-examples/heading.png" alt="Heading function example" width="45%">
...
```
<img src="function-examples/text.png" alt="Text function example" width="45%">
...
```
<img src="function-examples/image.png" alt="Image function example" width="45%">
...
```
<img src="function-examples/takePicture.png" alt="Take picture function example" width="45%">
...
```
<img src="function-examples/button.png" alt="Button function example" width="45%">
...
```
<img src="function-examples/question.png" alt="Question function example" width="45%">
...
```
<img src="function-examples/multiquestion.png" alt="Multichoice function example" width="45%">
...
```
<img src="function-examples/popup.png" alt="PopUp function example" width="45%">
...
```
<img src="function-examples/simpleMap.png" alt="Simple map function example" width="45%">
...
board("Final Results",
      ...
      "Difficulty", "Hard");
```
<img src="function-examples/board.png" alt="Board function example" width="45%">
...
```
<img src="function-examples/showAllImages.png" alt="Show all images function example" width="45%">
...
```
<img src="function-examples/shareButton.png" alt="Share button function example" width="45%">
...
```
<img src="function-examples/finishGameButton.png" alt="Finish game button function example" width="45%">
...
Another game example is available in the app/src/main/assets/bundled_games/com.rejnek.dejvice.alpha folder.
